      ...
      <div>
        ...
        <div className="relative z-20 px-4">
          ...
          <div className="flex gap-4 justify-center flex-wrap">
            <a
              href="/gallery"
              className="bg-cyan-500 hover:bg-cyan-600 text-white px-6 py-3 rounded-lg font-semibold shadow-xl transition-all duration-300 transform hover:scale-105"
            >
              Explore Animals
            </a>
            <a
              href="/tour"
              className="bg-orange-500 hover:bg-orange-600 text-white px-6 py-3 rounded-lg font-semibold shadow-xl transition-all duration-300 transform hover:scale-105"
            >
              Start Tour
            </a>
          </div>
